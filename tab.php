...
<!-- la MOYENNE -->
    <tr>
        ...
        <td class="gradient-box">
            <!-- Calcul de la moyenne des valeurs de glycémie du midi pour la semaine -->
            <p>0,80 mg min</p>
        </td>
        <td class="gradient-box">
            <!-- Calcul de la moyenne des valeurs de glycémie du soir pour la semaine -->
            <p>1,60 mg max</p>
        </td>
    </tr>
...
<!-- <td><input type="text" class="morning"></td>
<td><input type="text" class="midday"></td>
<td><input type="text" class="evening"></td> -->